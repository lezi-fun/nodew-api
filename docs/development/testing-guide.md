...
| `test/integration/operation-settings.test.ts` | Operation-config persistence and behavior. |
| `test/integration/payment-settings.test.ts` | Payment-setting persistence, secret redaction, and runtime checkout behavior. |
| `test/integration/ratio-settings.test.ts` | Model/group ratio storage and billing integration. |
